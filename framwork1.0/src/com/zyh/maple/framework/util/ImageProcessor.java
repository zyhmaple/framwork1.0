...
public class ImageProcessor {
	...
	private Image mirror(Image original, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
	...
	public static void cutImage(String imgOriginalPath, String imgDestPath, String suffix, int x, int y, int width,
	...
	public static void scaledImage(String imgOriginalPath, String imgDestPath, int newWidth, int newHeight,
